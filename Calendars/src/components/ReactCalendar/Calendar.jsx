...
function getActiveStartDate(props) {
  ...
  let valueFrom = getDetailValueFrom({
    value,
    minDate,
    maxDate,
    maxDetail,
  ...
  renderNavigation() {
    ...
    return (
      <Navigation
        ...
        view={view}
        views={views}
        onNextMouseEnter={onNextMouseEnter}
        onNextMouseLeave={onNextMouseLeave}
        onPrevMouseEnter={onPrevMouseEnter}
        onPrevMouseLeave={onPrevMouseLeave}
      />
    );
  }
